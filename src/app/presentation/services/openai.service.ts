...
export class OpenAiService {
  ...
  report(nombre: string, email: string, asunto: string): Observable<any> {
    return this.http.post(`${this.apiURL}/report`, { nombre, email, asunto });
  }
}
